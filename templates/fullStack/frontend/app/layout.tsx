...
export const metadata: Metadata = {
	...
	creator: "Rhein Sullivan (https://rheinsullivan.web.id)",
	publisher: "Vyagra Nexus™ (https://vyagranexus.rheinsullivan.web.id/in)",
	...
	jsonLd: {
		...
		"@graph": [
			...
			},
			{
				...
				name: "Vyagra Nexus",
				url: "https://vyagranexus.rheinsullivan.web.id/in",
