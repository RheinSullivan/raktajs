...
| **v1.1.8** | 2026-08 | Stabilisasi runtime core, penanganan signal HTTP/RPC (`panturaFetch`), pembatasan path traversal (`safePathJoin`), ekspansi 10 tag kustom & primitif resmi (`<click>`, `<picture>`, `<pantura>`, `<reborns>`, `<lazy>`, `<guard>`, `<seal>`, `<form>`, `<title>`, `<shelf>`), serta dokumentasi lengkap 15 backend adapter dan 12 mesin database dengan contoh integrasi end-to-end. |
