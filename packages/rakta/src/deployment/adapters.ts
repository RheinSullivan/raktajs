		...
		case "vercel":
			return {
				...
				files: [
						...
						content: JSON.stringify(
							{
								...
								buildCommand: "bun run build",
								outputDirectory: resolved.outDir,
								// framework: null keeps Vercel's auto-detection off so our
								// headers config is used instead.
								framework: null,
								headers: [
									{
										source: "/(.*)",
					...
					{
						// .vercel/project.json lets Vercel Dashboard show the correct framework.
						path: ".vercel/project.json",
						content: JSON.stringify(
							{ orgId: "", projectId: "", framework: "raktajs" },
							null,
							2,
						),
					},
		...
		case "netlify":
			return {
				...
				files: [
					{
						path: "netlify.toml",
						content: `# Generated by Rakta.js - https://raktajs.dev
[build]
