...
//   import { useCounterStore, http } from "./.rakta/autoImports";
`;
...
export function generateAutoImports(
	...
	writeFileSync(join(outputDir, "autoImports.ts"), tsContent, "utf-8");
	...
	if (options.generateDts) {
		...
		writeFileSync(join(outputDir, "autoImports.d.ts"), dtsContent, "utf-8");
	}
